...
public class ManageProdPanel extends javax.swing.JPanel {
    ...
    ManageProdPanel(JPanel rightPanel, ProductDirectory prodDir) {
        ...
        populate(prodDir.getProductDirectory(), "all");
    }
    
    public void populate(ArrayList<Product> prodList, String search){
...
//            CardLayout layout = (CardLayout) rightPanel.getLayout();
//            layout.next(rightPanel);
              populate(prodDir.getProductDirectory(), txtsearch.getText());
        }
        }
