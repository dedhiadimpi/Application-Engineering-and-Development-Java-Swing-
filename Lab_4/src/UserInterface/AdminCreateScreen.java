...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private boolean compareUserName(List<User> list){
        for(User u: list)
        {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        txtUser.setBorder(b);
        txtPword.setBorder(b);
        txtRePword.setBorder(b);
        ...
        if(radioCustomer.isSelected()){
            if(compareUserName(admin.custDir.getCustomerList())){
        ...
        if(radioSupplier.isSelected()){
            if(compareUserName(admin.suppDir.getSupplierList())){
                JOptionPane.showMessageDialog(null, "Username already exist!");
                txtUser.setText("");
                txtPword.setText("");
                txtRePword.setText("");
